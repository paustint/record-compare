...
- [ ] TABLE
  ...
  - [ ] HEADERS
    ...
    - [ ] require user to select a key (field to match source and target data)
...
- [ ] LOGGING
  - [ ] Figure out local logging
  - [ ] Figure out telemetrics (e.x. user action logging - ask user before collecting, if we decide to collect)
- [ ] PERFORMANCE
  - [ ] Have all work happen in a different thread
  - [ ] show loading indicators
  - [ ] Test very large datasets and create a plan for improving
    - [ ] Investigate lazy loading
    - [ ] See if turning off unsafe URL check is any faster
- [ ] NATIVE SUPPORT (OS)
  - [ ] notifications
  - [ ] open with....
